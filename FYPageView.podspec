#
#  Be sure to run `pod spec lint FYPageView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "谢菲旸"
  # spec.authors            = { "谢菲旸" => "xiefy@finchina.local" }
  # spec.social_media_url   = "https://twitter.com/谢菲旸"
